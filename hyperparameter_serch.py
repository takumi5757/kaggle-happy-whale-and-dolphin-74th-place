...
task = Task.init(
    project_name="20220317_Hyper-Parameter Optimization",
...
args = {
    "template_task_id": "4ee51e7c8db94b78858ee749e717875f",
...
# optimizers = ["cosineannealingwarmup", "cosineannealing"]
optimizers = ["cosineannealingwarmup"]
...
an_optimizer = HyperParameterOptimizer(
    ...
    hyper_parameters=[
        # UniformIntegerParameterRange(
        #     "General/layer_1", min_value=128, max_value=512, step_size=128
        # ),
        # UniformParameterRange(
        #     "General/optimizer/classifier_optimizer/lr",
        #     min_value=0.001,
        #     max_value=0.1,
        #     step_size=0.01,
        # ),
        # UniformParameterRange(
        #     "General/optimizer/encoder_optimizer/lr",
        #     min_value=0.001,
        #     max_value=0.1,
        #     step_size=0.01,
        # ),
        # UniformParameterRange(
        #     "General/optimizer/encoder_optimizer/weight_decay",
        #     min_value=0.00001,
        #     max_value=0.001,
        #     step_size=0.00001,
        # ),
        UniformParameterRange(
            "General/networks/classifier/m",
            min_value=0.1,
            max_value=0.9,
            step_size=0.1,
        ),
        UniformIntegerParameterRange(
            "General/networks/classifier/s",
            min_value=10,
            max_value=50,
            step_size=1,
        ),
        DiscreteParameterRange(
            "General/optimizer/classifier_optimizer/sched_type", values=optimizers
        ),
        DiscreteParameterRange(
            "General/optimizer/encoder_optimizer/sched_type", values=optimizers
        ),
        DiscreteParameterRange(
            "General/optimizer/classifier_optimizer/t_max", values=[20]
        ),
        DiscreteParameterRange(
            "General/optimizer/encoder_optimizer/t_max", values=[20]
        ),
        DiscreteParameterRange("General/batch_size", values=[64]),
        DiscreteParameterRange("General/epoch", values=[20]),
    ],
    # this is the objective metric we want to maximize/minimize
    objective_metric_title="knn_val",
    objective_metric_series="average_score",
